...
public:
	...
	*/
	 virtual error_t encryptBufferB(PL_key_t* key, uint8_t* buffer, uint8_t offset, uint8_t len);
	...
	/**
		...
		@return error_t status
	*/
	 virtual error_t decryptBufferB(PL_key_t* key, uint8_t* buffer, uint8_t offset, uint8_t len);
	...
	/**
		...
		@return error_t status
	*/	 
	 virtual error_t deriveKeyB(PL_key_t* masterKey, uint8_t* derivationData, uint8_t offset, uint8_t len, PL_key_t* derivedKey);
	...
	/**	
		...
		@return error_t status
	*/
	 virtual error_t hashDataBlockB( uint8_t* buffer, uint8_t offset, PL_key_t* key, uint8_t* hash);
	/**
		...
		@return error_t status
	*/
	 virtual error_t macBuffer(PL_key_t* key, uint8_t* buffer, uint8_t offset, uint8_t* pLen, uint8_t* mac);
	...
	/**
		...
		@return error_t status
	*/
	 virtual error_t verifyMac(PL_key_t* key, uint8_t* buffer, uint8_t offset, uint8_t* pLen);
	...
	/**
		...
		@return error_t status
	*/
	 virtual error_t protectBufferB( PL_key_t* key, uint8_t* buffer, uint8_t offset, uint8_t* pLen);
	...
	/**
		...
		@return error_t status
	*/
	 virtual error_t unprotectBufferB( PL_key_t* key, uint8_t* buffer, uint8_t offset, uint8_t* pLen);
	
	/**
		Command: self test of Cryptoraw component
		@return error_t SUCCESS or error message
	*/
	 virtual error_t selfTest();
};
