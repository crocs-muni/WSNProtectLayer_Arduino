...
public:
	...
	*/	
	virtual error_t protectBufferForNodeB( node_id_t nodeID, uint8_t* buffer, uint8_t offset, uint8_t* pLen) = 0;
	...
	/**
			...
			@return error_t status
	*/
	virtual error_t unprotectBufferFromNodeB( node_id_t nodeID, uint8_t* buffer, uint8_t offset, uint8_t* pLen) = 0;
	...
	/**
			...
			@return error_t status
	*/
	virtual error_t protectBufferForBSB( uint8_t* buffer, uint8_t offset, uint8_t* pLen) = 0;
	...
	/**
			...
			@return error_t status
	*/
	virtual error_t unprotectBufferFromBSB( uint8_t* buffer, uint8_t offset, uint8_t* pLen) = 0;
	...
	/**
			...
			@return error_t status
	*/
	virtual error_t macBufferForNodeB(node_id_t nodeID, uint8_t* buffer, uint8_t offset, uint8_t* pLen) = 0;
	...
	/**
			...
			@return error_t status
	*/
	virtual error_t macBufferForBSB( uint8_t* buffer, uint8_t offset, uint8_t* pLen) = 0;
	...
	/**
			...
			@return error_t status
	*/
	virtual error_t verifyMacFromNodeB( node_id_t nodeID, uint8_t* buffer, uint8_t offset, uint8_t* pLen) = 0;
	...
	/**
			...
			@return error_t status
	*/
	virtual error_t verifyMacFromBSB( uint8_t* buffer, uint8_t offset, uint8_t* pLen) = 0;
	...
	/**
			...
			@return error_t status
	*/
	virtual error_t initCryptoIIB() = 0;
	...
	/**	
			...
			@return error_t status
	*/
	virtual error_t hashDataB( uint8_t* buffer, uint8_t offset, uint8_t len, uint8_t* hash) = 0;
	...
	/**	
			...
			@return error_t status
	*/
	virtual error_t hashDataShortB( uint8_t* buffer, uint8_t offset, uint8_t len, uint32_t* hash) = 0;
	...
	*/
	virtual error_t verifyHashDataB( uint8_t* buffer, uint8_t offset, uint8_t pLen, uint8_t* hash) = 0;
	...
	/**	
			...
			@return error_t result
	*/
	virtual error_t verifyHashDataShortB( uint8_t* buffer, uint8_t offset, uint8_t pLen, uint32_t hash) = 0;
	...
	*/
	virtual error_t verifySignature( uint8_t* buffer, uint8_t offset, PRIVACY_LEVEL level, uint16_t counter, Signature_t* signature) = 0;
	
	/**
	                Command: to update last verified signature stored in memory
	                @param[in] signature value to update, length is required to be HASH_LENGTH
	*/	
	virtual void updateSignature( Signature_t* signature) = 0;
	
	/**
			Command: to precompute hash chain of signatures. This is intended for BS use only.
			...
			@return error_t status
	*/
	virtual error_t computeSignature( PRIVACY_LEVEL privacyLevel, uint16_t lenFromRoot, Signature_t* signature) = 0;
	/**
			Command: to execute self test of Crypto component
			@return error_t status
	*/
	virtual error_t selfTest() = 0;
